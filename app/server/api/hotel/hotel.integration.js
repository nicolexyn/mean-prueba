...
describe('Hotel API:', function() {
  ...
  describe('PUT /api/hotels/:id', function() {
    ...
    it('should respond with the original hotel', function() {
      expect(updatedHotel.name).to.equal('New Hotel');
      expect(updatedHotel.info).to.equal('This is the brand new hotel!!!');
    });
